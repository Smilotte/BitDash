...
public class Player : MonoBehaviour
{
    ...
    {
        //load game manager
        gameManager = GameObject.Find("Pixel UI Canvas").GetComponent<GameManager>();
        //load animator
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.DownArrow)&& canJump&&dashSwitch==true && GameManager.GameStart)
        {
        ...
        canJump = onGround();
        if (Input.GetKeyDown(KeyCode.UpArrow) && canJump && GameManager.GameStart)
        {
